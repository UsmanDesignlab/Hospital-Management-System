...
exports.supportedJoiTypes = void 0;
...
function createAllowTypes(details, settings) {
    const values = (0, joiUtils_1.getAllowValues)(details.allow);
    // at least one value
    if (values.length !== 0) {
        const allowedValues = values.map((value) => (0, types_1.makeTypeContentChild)({ content: typeof value === 'string' ? (0, utils_1.toStringLiteral)(value, settings.doublequoteEscape) : `${value}` }));
    ...
    if (values.length !== 0) {
        if (values.length === 1 && values[0] === '') {
            ...
            const allowedValues = values.map(value => stringAllowValues.includes(value) && value !== ''
                ...
                : (0, types_1.makeTypeContentChild)({ content: (0, utils_1.toStringLiteral)(value, settings.doublequoteEscape) }));
